    ...
    return (
        <div className='header'>
            ...
            <nav className='navBar' >
                <ul>
                    <Link className={accueil}  onClick={handleAccueil} to={"/"}>Accueil</Link>
                    <Link className={service} onMouseLeave={handleServiceLeave} onMouseEnter={handleService} to={"/"}>Service</Link>
                    {sousMenu === 1 ?
