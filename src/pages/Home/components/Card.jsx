...
const Card = () => {
    ...
    useEffect(() => {
        gsap.fromTo(".card",
            {
                x: -600, opacity: 0, keyframes: [{ x: 50, duration: 1 }, { x: 0, duration: 1 }], ease: "elastic.out(1, 0.3)"
            },
            {
    ...
    return (
        <div className="bgCard">
            <div className='card'>
                <div className='flex'><div className='icon'><CgSandClock /></div><div className="txt1">Sans engagement, ponctuellement ou régulièrement</div></div>
